...
u_int	i0,j0;
{
	...
	if ( in==out )
		return (out);
	/*  Next line commented out by Tim Massingham, tim.massingham@ebi.ac.uk
         *  6 March 2005 -- bug: out->m and out->n not updated if out is has 
         *  larger dimensions than in. m_resize does this.
         */
